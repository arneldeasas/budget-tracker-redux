        ...
        <div className='absolute bottom-0 bg-transparent flex justify-between py-2 text-3xl text-[#02bfc9] w-full '>
            ...
            <div className={`account-panel flex flex-col justify-between  ${openAccPanel ? 'account-panel-slide':''}`}>
                <div>
                    ...
                    <h2 className="text-[#0081a7] font-medium text-lg text-center">{UserData.username}</h2>
                    <h2 className="profile-name text-[#02bfc9] my-4">{`${UserData.firstname} ${UserData.lastname}`}</h2>
                </div>
